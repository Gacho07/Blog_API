    ...
    public class CreateBlogValidator : AbstractValidator<InsertBlogDto>
    {
        ...
        public CreateBlogValidator(BlogContext context)
        {
            ...
            RuleFor(x => x.Title).NotEmpty()
                                 ...
                                 .MinimumLength(3)
                                 .WithMessage("Title must contain more than 3 letters.");
